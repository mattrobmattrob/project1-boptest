...
<p>Packaged Single-Zone Rooftop Unit following the specifications of ASHRAE&apos;s HVAC System 3 (PZS-AC).</p>
  ...
  BaselineSystem3 HVAC(
    zonenb="1",
    mass_flow_nominal=0.527,
    heaNomPow=14035.23,
    CCNomPow=-8607.92) "Core zone HVAC system"
